...
src/%.o: ../src/%.c
	...
	/home/ysapir/CodeSourcery/Sourcery_CodeBench_Lite_for_ARM_GNU_Linux/bin/arm-none-linux-gnueabi-g++ -D__HOST__ -Dasm=__asm__ -Drestrict= -I../../matmul-16_commonlib/src -I/home/ysapir/Projects/zed/e-host/src -I/home/ysapir/Projects/zed/e-loader/src -O3 -Ofast -falign-loops=8 -funroll-loops -ffast-math -Wall -c -fmessage-length=0 -std=c99 -Wno-unused-result -static -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
