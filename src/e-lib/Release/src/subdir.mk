...
src/%.o: ../src/%.c
	...
	e-gcc -I../include -I/opt/adapteva/esdk/tools/gnu/epiphany-elf/include -O2 -falign-loops=8 -Wall -c -fmessage-length=0 -ffp-contract=fast -mlong-calls -mfp-mode=round-nearest -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
